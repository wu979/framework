...
-- ----------------------------
INSERT INTO `config_info` VALUES (24, 'application.yml', 'COMMON', 'server:\n  max-http-header-size: 102400\nspring:\n  mvc:\n    pathmatch:\n      matching-strategy: ANT_PATH_MATCHER\n  servlet:\n    multipart:\n      max-file-size: 500MB\n      max-request-size: 500MB\n#端口\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \"*\"\n  endpoint:\n    health:\n      show-details: always\n  security:\n    health:\n      elasticsearch:\n        enabled: false\n\n#日志\nlogging:\n  config: classpath:logback-spring.xml\n\n#trace\nskywalking:\n  traceId:\n    header: ${framework.skywalking.traceId:true}', 'a9cb2bf6f4876f18541b46e7758196e5', '2022-12-13 05:31:18', '2022-12-15 08:48:48', 'nacos', '0:0:0:0:0:0:0:1', '', '0e5ea9ed-691f-4059-b8cc-bac9f1ddc816', '', '', '', 'yaml', '');
...
INSERT INTO `config_info` VALUES (46, 'service.vgroupMapping.default_tx_group', 'SEATA', 'seata-cluster', '36795b6bcb77cf82c08904b91caa4c41', '2022-12-13 10:41:41', '2022-12-13 10:41:47', 'nacos', '0:0:0:0:0:0:0:1', '', '1146878a-9fec-4f49-947f-987f44bf5c78', '', '', '', 'text', '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 84 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '多租户改造' ROW_FORMAT = Dynamic;
