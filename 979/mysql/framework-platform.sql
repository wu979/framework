...
(
  ...
  COLLATE = utf8mb4_general_ci COMMENT = '动态路由'
  ROW_FORMAT = Dynamic;
...
VALUES (1274383603682214965, 'platform', 'lb://framework-cloud-platform-api',
        '[{\"args\":{\"_genkey_0\":\"/api/platform/**\"},\"name\":\"Path\"}]',
        '[{\"args\":{\"_genkey_0\":\"2\"},\"name\":\"StripPrefix\"}]', 2, '平台', b'1', 1542053786268950529,
        1542053786268950529, 1659492773302, 1659492773302, b'1', 0);
INSERT INTO `t_gateway_route`
VALUES (1274383603682346122, 'oauth', 'lb://framework-cloud-oauth-api',
        '[{\"args\":{\"_genkey_0\":\"/api/oauth/**\"},\"name\":\"Path\"}]',
        '[{\"args\":{\"_genkey_0\":\"1\"},\"name\":\"StripPrefix\"}]', 3, '授权', b'1', 1542053786268950529,
        1542053786268950529, 1659492773302, 1659492773302, b'1', 0);
INSERT INTO `t_gateway_route`
VALUES (1274383603682705409, 'user', 'lb://framework-cloud-user-api',
        '[{\"args\":{\"_genkey_0\":\"/api/user/**\"},\"name\":\"Path\"}]',
        '[{\"args\":{\"_genkey_0\":\"2\"},\"name\":\"StripPrefix\"}]', 1, '用户', b'1', 1542053786268950529,
        1542053786268950529, 1659492773302, 1659492773302, b'1', 0);
INSERT INTO `t_gateway_route`
VALUES (1554804122710949888, 'pay', 'lb://framework-cloud-pay-api',
        '[{\"args\":{\"_genkey_0\":\"/api/pay/**\"},\"name\":\"Path\"}]',
        '[{\"args\":{\"_genkey_0\":\"2\"},\"name\":\"StripPrefix\"}]', 5, '支付', b'1', 1542053786268950529, 1,
        1659529164379, 1659592944326, b'1', 40);
...
VALUES (1556552296967430144, 'WX-1000000', '微信支付-限额100万', 'WX', 'FG85O-230R4KJ', '3y3tg3ryh5uy5t3t3t3y',
        't2390hy34tj309k0r23r0k20rek20tj39t,3tj3t93ht38th38thj39tj39th398ht',
        't2390hy34tj309k0r23r0k20rek20tj39t,3tj3t93ht38th38thj39tj39th398ht',
        't2390hy34tj309k0r23r0k20rek20tj39t,3tj3t93ht38th38thj39tj39th398ht', '微信支付', b'1', 1542053786268950529,
        1542053786268950529, 1659945961598, 1659946294060, b'1', 5);
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '支付方式'
  ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_pay_mode
-- ----------------------------
INSERT INTO `t_pay_mode`
VALUES (1556555361023762432, 1556552296967430144, '23t3t423e2', 'WX_APP', 'v3', 'https://www.baidu.com', NULL, 3,
        '微信APP支付', b'1', 1542053786268950529, 1542053786268950529, 1659946692125, 1659946937292, b'1', 5);
...
VALUES (1518137211888954023, b'1', 1539534613520924673, 1);
...
(
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '租户'
  ROW_FORMAT = Dynamic;
...
VALUES (1539534613520924673, 'tenxun', '疼迅', 'e10adc3949ba59abbe56e057f20f883e', 'REVIEWED', 10,
        'https://www.baidu.com', -1, -1, 'all', 'authorization_code,password,client_credentials,refresh_token,implicit',
        NULL, 'false', NULL, 1542053786268950529, 1542053786268950529, 1655888629691, 1655888629692, b'1', 0);
INSERT INTO `t_tenant`
VALUES (1539534613520962784, 'alibaba', '阿狸巴巴', 'e10adc3949ba59abbe56e057f20f883e', 'REVIEWED', 10,
        'https://www.baidu.com', -1, -1, 'all', 'authorization_code,password,client_credentials,refresh_token,implicit',
        NULL, 'false', NULL, 1542053786268950529, 1542053786268950529, 1655888629691, 1655888629692, b'1', 0);
